...
import org.firstinspires.ftc.teamcode.hardware.ExpansionHubExt.RevBulkData;
...
public class ExpansionHub extends LynxCommExceptionHandler implements HardwareDevice {
    ...
    ExpansionHub(LynxModule controlHub) {
    ...
    {
        LynxSetModuleLEDColorCommand colorCommand = new LynxSetModuleLEDColorCommand(controlHub, r, g, b);
        try
        {
            colorCommand.send();
        }
    ...
    public synchronized void setI2cBusSpeed(int bus, I2cBusSpeed speed)
    {
        ...
        LynxI2cConfigureChannelCommand command = new LynxI2cConfigureChannelCommand(controlHub, bus, speedCode);
        try
        {
            command.send();
        }
    ...
    {
        LynxGetADCCommand command = new LynxGetADCCommand(controlHub, LynxGetADCCommand.Channel.BATTERY_CURRENT, LynxGetADCCommand.Mode.ENGINEERING);
        try
        {
    ...
    public synchronized double getServoBusCurrentDraw(CurrentDrawUnits units)
    {
        ...
        LynxGetADCCommand command = new LynxGetADCCommand(controlHub, channel, LynxGetADCCommand.Mode.ENGINEERING);
        try
        {
            LynxGetADCResponse response = command.sendReceive();
    ...
    {
        LynxGetModuleStatusCommand command = new LynxGetModuleStatusCommand(controlHub);
    ...
    {
        LynxPhoneChargeQueryCommand command = new LynxPhoneChargeQueryCommand(controlHub);
    ...
    {
        LynxPhoneChargeControlCommand controlCommand = new LynxPhoneChargeControlCommand(controlHub, chargeEnabled);
        try
        {
            controlCommand.send();
        }
    ...
    {
        LynxSetServoPulseWidthCommand command = new LynxSetServoPulseWidthCommand(controlHub, port, uS);
    ...
    public synchronized RevBulkData getBulkInputData()
    {
        ...
        try
        {
            ...
            return new RevBulkData(response, controlHub);
        }
    ...
    public synchronized String getFirmwareVersion()
    {
        ...
        String inputstring = controlHub.getFirmwareVersionString();
    ...
    {
        return controlHub.getManufacturer();
    }

    @Override
    public String getDeviceName()
    {
        return controlHub.getDeviceName();
    }

    @Override
    public String getConnectionInfo()
    {
        return controlHub.getConnectionInfo();
    }

    @Override
    public int getVersion()
    {
        return controlHub.getVersion();
    }

    @Override
    public void resetDeviceConfigurationForOpMode()
    {
        controlHub.resetDeviceConfigurationForOpMode();
    }
